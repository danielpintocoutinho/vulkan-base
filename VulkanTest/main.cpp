...
private:
	...
	void initWindow() {
		...
		this->window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "HelloTriangle", nullptr, nullptr);
	}
	...
	void createVulkanInstance() {
		...
		std::cout << "checkIfAllGlfwExtensionsSupported: " << checkIfAllGlfwExtensionsSupported(glfwExtensions, extensions) << std::endl;
...
int main() {
	...
	std::cout << "Enable validation layers: " << enableValidationLayers << std::endl;
